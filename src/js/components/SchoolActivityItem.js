...
import 'less/schoolactivityitem.less'

const SchoolActivityItem = (props) => (
    <div className="activity-item uk-flex uk-margin-small-bottom uk-position-relative">
...
export default SchoolActivityItem